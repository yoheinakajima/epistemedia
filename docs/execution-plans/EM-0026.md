...
Status: v1 preflight failed and retained; v2 protocol frozen; traces and source review pending.
...
quantitative basis, scope, counterevidence, and unknowns.
...
commit before its answer is admissible. No empirical finding has been accepted, and no Case 002
dossier exists.
