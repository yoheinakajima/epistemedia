...
1. **OpenAI, “GPT-4 Technical Report.”**
   ...
   - Editions: [v1 PDF](https://arxiv.org/pdf/2303.08774v1), submitted 15 March
     2023; [v6 HTML](https://arxiv.org/html/2303.08774v6) and
     [v6 PDF](https://arxiv.org/pdf/2303.08774v6), submitted 4 March 2024;
     [official unversioned mirror](https://cdn.openai.com/papers/gpt-4.pdf).
...
2. **Daniel Martin Katz, Michael James Bommarito, Shang Gao, and Pablo Arredondo,
   ...
   - Version of record DOI: `10.1098/rsta.2023.0254`; PMCID `PMC10894685`;
     PMID `38403056`.
   - Access: [DOI](https://doi.org/10.1098/rsta.2023.0254),
     [PMC full text](https://pmc.ncbi.nlm.nih.gov/articles/PMC10894685/), and
     [Europe PMC XML](https://www.ebi.ac.uk/europepmc/webservices/rest/PMC10894685/fullTextXML).
   ...
   - Preprint identity: SSRN DOI `10.2139/ssrn.4389233`,
     [landing page](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4389233);
     automation-sensitive, no open license established, and quote-minimal only.

3. **Authors' artifact repository.**
   - Pinned tree:
     [`90997f740c7197f3f300b013e4345e2ad5621f96`](https://github.com/mjbommar/gpt4-passes-the-bar/tree/90997f740c7197f3f300b013e4345e2ad5621f96);
     [recursive inventory](https://api.github.com/repos/mjbommar/gpt4-passes-the-bar/git/trees/90997f740c7197f3f300b013e4345e2ad5621f96?recursive=1).
...
4. **Royal Society Figshare supplement.**
   - Collection DOI `10.6084/m9.figshare.c.7031287.v1`;
     [article DOI](https://doi.org/10.6084/m9.figshare.25018513.v1);
     [article API](https://api.figshare.com/v2/articles/25018513).
...
5. **Illinois Board of Admissions percentile-equivalent charts.**
   - [February 2018](https://www.ilbaradmissions.org/percentile-equivalent-charts-feb-2018):
     one-page PDF; `300 -> 90th`, `290 -> 85th`.
   - [July 2018](https://www.ilbaradmissions.org/percentile-equivalent-charts-july-2018):
     one-page PDF; `300 -> 70th`, `290 -> 59th`.
   - [February 2019](https://www.ilbaradmissions.org/percentile-equivalent-charts-february-2019):
...
6. **National Conference of Bar Examiners.**
   - [UBE score mechanics](https://www.ncbex.org/exams/ube/ube-scores): official HTML;
     total scale 400, with 50% MBE, 30% MEE, and 20% MPT.
   - [2022 MBE distribution](https://thebarexaminer.ncbex.org/2022-statistics/the-multistate-bar-examination-mbe/):
     official HTML; February `N=16,504`, July `N=44,705`, total `N=61,209`.
   - [2022 statistics snapshot](https://thebarexaminer.ncbex.org/2022-statistics/2022-statistics-snapshot/):
   ...
   - [First-time/repeater table](https://thebarexaminer.ncbex.org/2022-statistics/first-time-exam-takers-and-repeaters-in-2022/):
...
7. **Eric Martínez, “Re-evaluating GPT-4's bar exam performance.”**
   - Version of record DOI `10.1007/s10506-024-09396-9`;
     [full text](https://link.springer.com/article/10.1007/s10506-024-09396-9);
     [Texas A&M record](https://scholarship.law.tamu.edu/facscholar/2405/).
...
8. **Martínez OSF analysis/code deposit.**
   - Exact anonymous capability URL:
     [OSF `c8ygu`](https://osf.io/c8ygu/?view_only=dcc617accc464491922b77414867a066);
     [API form](https://api.osf.io/v2/nodes/c8ygu/?view_only=dcc617accc464491922b77414867a066).
